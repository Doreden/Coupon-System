...
import com.dor.couponsprojectapp.security.CustomUserDetailsService;
import com.dor.couponsprojectapp.security.JwtRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/authentication/login","/user/**").permitAll()
